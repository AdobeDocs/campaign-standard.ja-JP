---
title: テンプレートについて
description: Adobe Campaign テンプレートを使用すると、ニーズに応じてパラメーターを事前設定できます。テンプレートにはマーケティングアクティビティの完全な設定や一部の設定が含まれていることがあり、技術系ではないエンドユーザー向けにAdobe Campaignの使用を簡単に行うことができます。
audience: start
