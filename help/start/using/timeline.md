...
* ![](assets/timeline_zoom_in.png)日が表示されるまで、より限られた期間で周囲を減らすか、詳細レベルを上げます
* ![](assets/timeline_zoom_out.png)は周囲を増やすか、より大きな時間枠を表示します
...
* ![](assets/timeline_email_icon.png)通のメール
