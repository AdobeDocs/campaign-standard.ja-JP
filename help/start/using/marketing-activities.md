...
description: キャンペーン、電子メール、SMS、プッシュ通知の配信、ランディングページ、ワークフローなど、マーケティング活動を作成および管理する方法について説明します。 新しいアクティビティを簡単にデザインし、既存のアクティビティを編集し、ステータスと有効性を確認することができます。
audience: start
...
## マーケティング活動の作成 {#creating-a-marketing-activity}
...
* SMSの作成 – [詳細情報](../../channels/using/creating-an-sms-message.md)
...
>[!NOTE]
>
>また、マーケティングアクティビティリストからマーケティングアクティビティを作成することもできます。 この場合、任意のタイプのアクティビティを作成し、アクティビティのプロパティを使用してマーケティングアクティビティを親キャンペーン（またはプログラムを作成する場合は親プログラム）にリンクすることを選択できます。
