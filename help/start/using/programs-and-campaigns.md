...
## 計画、プログラム、キャンペーンについて {#about-plans--programs-and-campaigns}
...
リスト内のプログラムとキャンペーンのそれぞれには、実行ステータスを示す視覚的なシンボルと色の付いたアイコンが表示されます。 このステータスは、プログラムまたはキャンペーンの有効期間に応じて異なります。
