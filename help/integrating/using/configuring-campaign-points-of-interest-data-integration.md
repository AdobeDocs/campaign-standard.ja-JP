...
1. アプリケーションを追加します。
   ...
   Mobile Services でのアプリケーションの管理について詳しくは、[Adobe Mobile Services ドキュメント &#x200B;](https://experienceleague.adobe.com/docs/mobile-services/using/manage-apps-ug/t-new-app.html?lang=ja) を参照してください。

1. 目標点を定義します。

   目標点の管理について詳しくは、[Adobe Mobile Services ドキュメント &#x200B;](https://experienceleague.adobe.com/docs/mobile-services/using/location-ug/t-manage-points.html?lang=ja) を参照してください。
