...
* **入力**:
   ...
   * Dynamics 365から&#x200B;**連絡先**&#x200B;をキャンペーンに取り込む
...
>[!NOTE]
>
>電子メールミラーページの有効期限は、対応するキャンペーン電子メールチャネルアクティビティの設定画面で変更できます（[有効期間パラメーター](../../administration/using/configuring-email-channel.md#validity-period-parameters)を参照）。
