...
![Campaign コントロールパネル](assets/do-not-localize/cp-icon.png) **新しいCampaign コントロールパネルリリース**. [詳細情報](https://experienceleague.adobe.com/docs/control-panel/using/release-notes.html?lang=ja){target=&quot;_blank&quot;}。
