...
新しいセクションでは、Campaign StandardとAdobeのリアルタイム・カスタマー・データ・プラットフォーム(RTCDP)間でデータを共有するための、Adobe Experience Platformのソースと宛先の使い方について説明しました。 [詳細情報](../../integrating/using/get-started-sources-destinations.md)
