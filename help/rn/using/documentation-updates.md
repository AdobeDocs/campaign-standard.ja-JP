...
## ドキュメントのアップデート - 2020 年 4 月 {#doc-updates-april-2020}

Microsoft Dynamics 365 と Adobe Campaign Standard の統合に関するドキュメントが、コアドキュメントで利用できるようになりました。[詳細を表示](../../integrating/using/working-with-campaign-standard-and-microsoft-dynamics-365.md)
...
## ドキュメントのアップデート - 2020 年 3 月 {#doc-updates-march-2020}
...
**[!UICONTROL Workflow]** の組み込み権限に関する情報が追加されました。[詳細を表示](../../administration/using/list-of-roles.md)
...
## ドキュメントのアップデート - 2020 年 1 月 {#doc-updates-january-2020}
...
## ドキュメントのアップデート - 2019 年 12 月 {#doc-updates-december-2019}
...
Microsoft Dynamics 365 統合（GA） - [詳細情報](../../integrating/using/working-with-campaign-standard-and-microsoft-dynamics-365.md)
...
## ドキュメントのアップデート - 2019 年 10 月 {#doc-updates-october-2019}
...
## ドキュメントのアップデート - 2019 年 9 月 {#doc-updates-september-2019}
...
## ドキュメントのアップデート - 2019 年 8 月 {#doc-updates-august-2019}
...
Microsoft Dynamics 365 コネクタの実装と使用に関する一連の新しいヘルプ記事が作成されました。この機能は現在、使用が制限されています。[詳細を表示](../../integrating/using/working-with-campaign-standard-and-microsoft-dynamics-365.md)
...
## ドキュメントのアップデート - 2019 年 7 月 {#doc-updates-2019}
...
パラメーターを使用してワークフローを呼び出す場合の、集計期間のない反復配信の使用に関する推奨事項が追加されました。[詳細を表示](../../automating/using/calling-a-workflow-with-external-parameters.md)
...
ディメンションと指標の互換性をより深く理解できるように、動的レポートの互換性の表が追加されました。[詳細を表示](https://docs.campaign.adobe.com/doc/standard/en/Technotes/dynamic_report_compatibility.pdf)
...
プッシュ通知組み込みレポートの節を更新しました。[詳細を表示](../../reporting/using/push-notification-report.md)
...
ユーザーとセキュリティガイドが更新され、18.7 リリース以降、新しい Campaign Standard インスタンスおよび地理的単位が作成されていない既存インスタンスで、地理的単位機能が廃止されたことが反映されています。[詳細を表示](https://helpx.adobe.com/jp/campaign/kb/acs-deprecated-and-removed-features.html)
...
Triggers との統合でサポートされる Analytics SKU のリストが更新されました。[詳細を表示](../../integrating/using/configuring-triggers-in-experience-cloud.md#configuring-solutions-and-services)
...
認証のリストが記載された節は削除されました。[詳細を表示](https://docs.campaign.adobe.com/doc/standard/en/Technotes/AdobeCampaign-ACSRights.pdf)（PDF）
...
Audience Manager または People コアサービスとの統合を設定する手順が更新されました。[詳細を表示](../../integrating/using/provisioning-and-configuring-integration-with-audience-manager-or-people-core-service.md)
...
反復プッシュ通知 - [詳細を表示](../../automating/using/push-notification-delivery.md)
...
Triggers 統合：2 つの使用例が追加されました。[詳細を表示](../../integrating/using/abandonment-triggers-use-cases.md)
