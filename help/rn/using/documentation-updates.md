...
Information was added on the new sorting option in the **Transfer file** activity. [詳細情報](../../automating/using/transfer-file.md)
...
Information was added on the new **Test** activity. [詳細情報](../../automating/using/test.md)
...
The API documentation was updated with information on the **History** API. プロファイルに送信された配信のミラーページを取得する方法について、使用事例が追加されました。[詳細情報](https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#how-to-retrieve-the-mirror-page-for-a-delivery-sent-to-a-profile)
...
Added information on the **Update Direct mail quarantines and delivery logs** import template. [詳細情報](../../automating/using/defining-import-templates.md)
...
A new option allowing to gain performance when defining many additional data in a **[!UICONTROL Query]** is now available. [詳細情報](../../automating/using/query.md)

プロファイルインポートの例は、いくつかのヒントで更新され、プロファイルをダイレクトメールを受信できるようになりました。[詳細情報](../../automating/using/importing-data.md)

A new activity is available in workflows: the **[!UICONTROL Enrichment]** activity. [詳細情報](../../automating/using/enrichment.md)
...
Reorganized the **[!UICONTROL Customizing a push notification]** section with step-by-step use cases. [詳細情報](../../channels/using/customizing-a-push-notification.md)
