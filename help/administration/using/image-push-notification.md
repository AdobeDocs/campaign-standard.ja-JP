...
# Adobe Campaign Standard のプッシュ通知からの画像の表示 {#image-push}
...
1. プッシュ通知コンテンツページで、「アドバンスオプション」セクションにアクセスします。

1. 「リッチメディアコンテンツのURL」フィールドにファイルのURLを入力します。
...
1. Xcodeプロジェクトで、 **File** / **New** / **Targetを選択します**。
