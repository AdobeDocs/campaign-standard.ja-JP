...
+ リリースノート {#release-notes}
  ...
  + {hide-from-toc}[トラッキングされた URL の署名に関する問題](rn/using/tracked-urls.md)
  + {hide-from-toc}[最新のドキュメントのアップデート](rn/using/documentation-updates.md)
+ はじめに {#getting-started}
  ...
  + マーケティングアクティビティの操作 {#marketing-plans}
  ...
  + {hide-from-toc}[ヘルプとサポートオプション](support.md)
+ プロファイルとオーディエンス {#profiles-and-audiences}
  ...
  + オプトインとオプトアウトのプロセスについて {#understanding-opt-in-and-opt-out-processes}
...
+ テストと送信 {#testing-and-sending}
  ...
  + メッセージのモニタリング {#monitoring-messages}
...
+ 他のソリューションとの統合 {#integrating-with-adobe-cloud}
  ...
  + モバイル向け Campaign と Analytics {#working-with-campaign-and-analytics-for-mobile}
...
+ 管理 {#administrating}
  ...
  + チャネルの設定 {#configuring-channels}
    ...
    + {hide-from-toc}[メールトラッキングピクセルに関する CNIL ガイダンス](administration/using/cnil-pixel-tracking.md)
