...
+ 通信チャネル {#communication-channels}
   ...
   + ダイレクトメール {#direct-mail}
      ...
      + [ダイレクトメールの対象ユーザーの定義](channels/using/defining-the-direct-mail-audience.md)
   ...
   + ランディングページ {#landing-pages}
      ...
      + [ランディングページの構造とスタイルの管理](channels/using/managing-landing-page-structure-and-style.md)
      + [ランディングページフォームデータプロパティの変更](channels/using/changing-a-landing-page-form-data-properties.md)
      + [ランディングページでの動的コンテンツの定義](channels/using/defining-dynamic-content-in-a-landing-page.md)
+ 電子メールコンテンツのデザイン {#designing-content}
   ...
   + [スタイルの管理](designing/using/styles.md)
...
+ レポート {#reporting}
   ...
   + レポートのリスト {#list-of-reports}
      ...
      + [直帰率の概要](reporting/using/bounce-summary.md)
      + [ドメイン別の分類](reporting/using/breakdown-by-domains.md)
      + [苦情数](reporting/using/complaints.md)
...
+ Adobe cloudとの連携 {#integrating-with-adobe-cloud}
   ...
   + [CampaignとAssetsコアサービスの使用](integrating/using/working-with-campaign-and-assets-core-service.md)
   + Mobile用のCampaignとAnalyticsの操作 {#working-with-campaign-and-analytics-for-mobile}
      ...
      + [目標地点データを使用したキャンペーンメッセージのパーソナライズ](integrating/using/personalizing-campaign-messages-with-point-of-interest-data.md)
   + キャンペーンとトリガーの操作 {#working-with-campaign-and-triggers}
      ...
      + [Experience cloudでのTriggersの設定](integrating/using/configuring-triggers-in-experience-cloud.md)
...
+ プロセスとデータの管理 {#managing-processes-and-data}
   ...
   + ターゲティングアクティビティ {#targeting-activities}
      + [ターゲット設定アクティビティについて](automating/using/about-targeting-activities.md)
      ...
      + [閲覧者](automating/using/read-audience.md)
   ...
   + 使用例：ワークフロー {#workflow-use-case}
      ...
      + [週別配信の作成](automating/using/workflow-weekly-offer.md)
      + [場所でのセグメントの作成](automating/using/workflow-segmentation-location.md)
      + [非オープンユーザーの再ターゲット設定](automating/using/workflow-cross-channel-retargeting.md)
+ 開発中 {#developing}
   ...
   + リソースの追加または拡張 {#adding-or-extending-a-resource}
      ...
      + [複合IDキーを使用したリソースの呼び出し](developing/using/uc-calling-resource-id-key.md)
...
+ 管理 {#administrating}
   ...
   + アプリケーション設定 {#application-settings}
      ...
      + [データ リテンション](administration/using/data-retention.md)
      + [更新と保守の操作](administration/using/updates-and-maintenance-operations.md)
