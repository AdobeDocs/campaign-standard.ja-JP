...
# Adobe Campaign Standardヘルプ {#using}
...
+ はじめに {#getting-started}
   + Adobe Campaignについて {#about-adobe-campaign}
      ...
      + [追跡、監視およびレポート](start/using/tracking--monitoring-and-reporting.md)
...
+ プロファイルとオーディエンス {#profiles-and-audiences}
   + [プロファイルとオーディエンスについて](audiences/using/about-profiles-and-audiences.md)
   + プロファイルの管理 {#managing-profiles}
      ...
      + [アクティブプロファイル](audiences/using/active-profiles.md)
   ...
   + オプトインプロセスとオプトアウトプロセスについて {#understanding-opt-in-and-opt-out-processes}
...
+ 通信チャネル {#communication-channels}
   + 通信チャネルについて {#about-communication-channels}
      + [通信チャネルの発見](channels/using/discovering-communication-channels.md)
   ...
   + ランディングページ {#landing-pages}
      ...
      + [データストレージと紐付け](channels/using/data-storage-and-reconciliation.md)
...
+ コンテンツのデザイン {#designing-content}
   + コンテンツデザインについて {#about-content-design}
      + [Adobe Campaignでのコンテンツのデザイン](designing/using/designing-content-in-adobe-campaign.md)
      + [コンテンツデザインのベストプラクティス](designing/using/content-design-best-practices.md)
   ...
   + ランディングページのコンテンツの編集 {#editing-landing-page-content}
      + [ランディングページコンテンツデザインについて](designing/using/about-landing-page-content-design.md)
   ...
   + SMSおよびプッシュコンテンツの編集 {#editing-sms-and-push-content}
      + [SMSおよびプッシュコンテンツデザインについて](designing/using/about-sms-and-push-content-design.md)
      + [SMSおよびプッシュコンテンツエディターのインターフェイス](designing/using/sms-and-push-content-editor-interface.md)
   + コンテンツの読み込み {#loading-content}
      + [既存のコンテンツの選択](designing/using/selecting-an-existing-content.md)
      + [ファイルからのコンテンツの読み込み](designing/using/importing-content-from-a-file.md)
      + [URLからのコンテンツの読み込み](designing/using/importing-content-from-a-url.md)
      + [Email Designerを使用した既存のコンテンツの編集](designing/using/editing-existing-contents-with-the-email-designer.md)
   + 画像の使用 {#using-images}
      + [画像の挿入](designing/using/inserting-images.md)
      + [画像プロパティの設定](designing/using/setting-up-image-properties.md)
      + [Adobe Creative SDKでの画像の変更](designing/using/modifying-images-with-the-adobe-creative-sdk.md)
      + [画像ソースのパーソナライズ](designing/using/personalizing-an-image-source.md)
   + コンテンツのパーソナライズ {#personalizing-content}
      + [パーソナライゼーションについて](designing/using/about-personalization.md)
      ...
      + [送信者をパーソナライズする](designing/using/personalizing-the-sender.md)
      + [電子メールの件名行のパーソナライズ](designing/using/personalizing-the-subject-line-of-an-email.md)
      + [例:電子メールのパーソナライゼーション](designing/using/example--email-personalization.md)
   + 条件付きコンテンツの定義 {#defining-conditional-content}
      + [表示条件の定義](designing/using/defining-a-visibility-condition.md)
      + [電子メールでの動的コンテンツの定義](designing/using/defining-dynamic-content-in-an-email.md)
      + [ランディングページでの動的コンテンツの定義](designing/using/defining-dynamic-content-in-a-landing-page.md)
      + [動的テキストの定義](designing/using/defining-dynamic-text.md)
   + リンクの管理 {#managing-links}
      + [リンクの挿入](designing/using/inserting-a-link.md)
      + [URLのパーソナライズ](designing/using/personalizing-urls.md)
      + [追跡されているURLについて](designing/using/about-tracked-urls.md)
+ テストと送信 {#testing-and-sending}
   + [Campaignとのメッセージの送信について](sending/using/about-sending-messages-with-campaign.md)
...
+ レポート {#reporting}
   ...
   + レポートのリスト {#list-of-reports}
      ...
      + [ドメインごとの分類](reporting/using/breakdown-by-domains.md)
      + [苦情](reporting/using/complaints.md)
      + [配信サマリ](reporting/using/delivery-summary.md)
      + [配信のスループット](reporting/using/delivery-throughput.md)
      + [アプリ内レポート](reporting/using/in-app-report.md)
      + [配信不能数およびバウンス](reporting/using/non-deliverables-and-bounces.md)
      + [開く](reporting/using/opens.md)
      + [プッシュ通知レポート](reporting/using/push-notification-report.md)
      + [SMSレポート](reporting/using/sms-report.md)
      + [トラッキングインジケーター](reporting/using/tracking-indicators.md)
...
+ Adobe Cloudとの統合 {#integrating-with-adobe-cloud}
   ...
   + キャンペーンおよびExperience Managerの操作 {#working-with-campaign-and-experience-manager}
      + [Experience Managerとの統合](integrating/using/integrating-with-experience-manager.md)
      + [Experience Managerでのキャンペーンフォームの作成 ](integrating/using/creating-a-campaign-form-in-experience-manager-.md)
   + キャンペーンとTargetの使用 {#working-with-campaign-and-target}
   ...
   + キャンペーンとAnalyticsの使用 {#working-with-campaign-and-analytics}
      + [Campaign- Analytics統合について](integrating/using/about-campaign-analytics-integration.md)
      + [Campaign- Analytics統合の設定](integrating/using/configure-campaign-analytics-integration.md)
      + [Analyticsのキャンペーンディメンションと指標](integrating/using/campaign-dimensions-and-metrics-in-analytics.md)
   + CampaignおよびAudience ManagerまたはPeopleコアサービスの使用 {#working-with-campaign-and-audience-manager-or-people-core-service}
      ...
      + [Audience ManagerまたはPeopleコアサービスとの統合および統合の設定](integrating/using/provisioning-and-configuring-integration-with-audience-manager-or-people-core-service.md)
      + [トラブルシューティング](integrating/using/troubleshooting.md)
      + [Audience ManagerまたはPeopleコアサービスでのオーディエンスの共有](integrating/using/sharing-audiences-with-audience-manager-or-people-core-service.md)
   + [CampaignコアサービスとAssetsコアサービスの使用](integrating/using/working-with-campaign-and-assets-core-service.md)
   + モバイル用のCampaignおよびAnalyticsの操作 {#working-with-campaign-and-analytics-for-mobile}
      + [キャンペーン目標地点データ統合について](integrating/using/about-campaign-points-of-interest-data-integration.md)
      + [キャンペーン目標地点データ統合の設定](integrating/using/configuring-campaign-points-of-interest-data-integration.md)
      + [目標地点データのあるキャンペーンメッセージのパーソナライズ](integrating/using/personalizing-campaign-messages-with-point-of-interest-data.md)
   + キャンペーンおよびトリガーの操作 {#working-with-campaign-and-triggers}
      + [Adobe Experience Cloud Triggersについて](integrating/using/about-adobe-experience-cloud-triggers.md)
      + [Experience Cloudでのトリガーの設定](integrating/using/configuring-triggers-in-experience-cloud.md)
      + [キャンペーンでのTriggersの使用](integrating/using/using-triggers-in-campaign.md)
...
+ プロセスとデータの管理 {#managing-processes-and-data}
   + ワークフローとデータ管理について {#about-workflows-and-data-management}
      + [ワークフローデータとプロセス](automating/using/workflow-data-and-processes.md)
      + [ワークフローの発見](automating/using/discovering-workflows.md)
      + [ワークフローの操作の原則](automating/using/workflow-operating-principles.md)
   ...
   + ワークフローの一般操作 {#workflow-general-operation}
      ...
      + [ターゲットデータ](automating/using/targeting-data.md)
...
+ 開発中 {#developing}
   ...
   + 使用例:APIの拡張 {#use-case--extending-the-api}
      ...
      + [手順1:プロファイルリソースへの拡張フィールドの追加](developing/using/step-1--add-extension-fields-to-the-profile-resource.md)
   ...
   + 使用例:リソースの拡張 {#use-cases--extending-resources}
      + [プロファイルリソースの新しいフィールドへの拡張](developing/using/extending-the-profile-resource-with-a-new-field.md)
...
+ 管理 {#administrating}
   ...
   + チャネルの設定 {#configuring-channels}
      ...
      + [SMSチャネルの設定](administration/using/configuring-sms-channel.md)
   ...
   + タイポロジルールの操作 {#working-with-typology-rules}
      ...
      + [制御ルール](administration/using/control-rules.md)
   + アプリケーションの設定 {#application-settings}
      + [外部アカウント](administration/using/external-accounts.md)
      + [キャンペーンのTargetマッピング](administration/using/target-mappings-in-campaign.md)
