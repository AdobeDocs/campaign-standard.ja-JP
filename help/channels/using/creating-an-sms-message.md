...
詳細な SMS パラメーターについて詳しくは、[SMS 設定](../../administration/using/configuring-sms-channel.md)の節を参照してください。
...
送信が完了したら、ビルトインの配信レポートまたはカスタム配信レポートを使用して、メッセージの影響の測定を開始できます。

**関連トピック：**

* [SMSおよびプッシュコンテンツ編集について](../../channels/using/about-sms-and-push-content-design.md)
* [テンプレートの管理](../../start/using/marketing-activity-templates.md)

## チュートリアルビデオ {#video}

このビデオでは、SMS配信の作成方法を説明します。

>[!VIDEO](https://video.tv.adobe.com/v/328377/?captions=jpn&quality=12)
