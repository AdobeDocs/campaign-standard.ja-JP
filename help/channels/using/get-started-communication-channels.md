...
Adobe Campaignを活用すると、あらゆるチャネルをまたいでキャンペーンを展開、測定、自動化できます。
...
**Campaign メッセージダッシュボード**&#x200B;を活用して、メッセージを1か所から設定および送信したり、スケジュール設定や多言語メッセージなど、様々な機能にアクセスしたりできます…

**テンプレートを管理**&#x200B;してメッセージのプロパティを設定し、メッセージ戦略全体で時間と一貫性を確保できます。 例えば、電子メールの場合、テンプレートの設定を担当する機能管理者は、オーディエンス、スケジュール、コンテンツなどの電子メールの標準パラメーター、送信、有効性、トラッキングなどに関連する高度なパラメーター、ターゲティングおよびパーソナライゼーションに関する事前設定パラメーター（ターゲティングコンテキスト）を定義できます。
...
**Adobe Campaignでは、電子メール、SMS メッセージ、プッシュ通知、アプリ内メッセージ、ダイレクトメール配信の5つのコミュニケーションチャネル**&#x200B;を利用できます。

各チャネルには、特定の機能があります。 例えば、メールチャネルでは、メールメッセージのバージョンを3つまでテストするために、A/B テストを実行できます。 SMS チャネルを使用して、STOP SMS メッセージを管理し、受信者から受信したSMSをデータベースに保存します。

さらに、**Campaign Standardのパーソナライゼーション機能と動的コンテンツ機能**&#x200B;を活用して、オーディエンスの関心を惹き付けることができます。
...
**ウェルカムメッセージ、注文出荷確認、パスワード変更など、個別のメッセージやユニークなメッセージ**&#x200B;をリアルタイムでお客様に送信します。

トランザクションメッセージは、オプションに応じて、メール、SMS、プッシュ通知チャネルで利用できます。 メッセージには、プロファイル情報を含まないイベントをターゲットとする&#x200B;**イベントトランザクションメッセージ**&#x200B;と、データベースからプロファイルをターゲットとする&#x200B;**プロファイルトランザクションメッセージ**&#x200B;の2種類があります。
...
Campaignには、**オーディエンスに関する情報の取得** サービスへのサブスクリプションの提供、データの表示、データベースの拡張に使用できるweb フォームであるランディングページが付属しています。

ランディングページは、**既存のプロファイルの取得または更新**&#x200B;や、ダブルオプトインメカニズムの設定にも使用でき、不正または無効なメールアドレスやスパムボットからプラットフォームを保護できます。
...
* [メールコンテンツのデザイン](../../designing/using/designing-content-in-adobe-campaign.md)
...
* [コミュニケーションチャネルのチュートリアルビデオ](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/communication-channels/email/create-email-from-homepage.html?lang=ja)
