...
この例では、[イベント](../../administration/using/configuring-transactional-messaging.md#use-case--configuring-an-event-to-send-a-transactional-message)の作成時に定義した3つのフィールドを追加して、トランザクションメッセージをパーソナライズする方法を学びます。名、最後に問い合わせた製品、買い物かごの総数

これを行うには、[個人設定フィールド](../../designing/using/personalization.md#inserting-a-personalization-field)をメッセージ内に挿入します。
...
1. **[!UICONTROL Context]** > **[!UICONTROL Real-time event]** > **[!UICONTROL Event context]**&#x200B;を閲覧して、パーソナライゼーションフィールドを取得します。名、最後に問い合わせた製品、買い物かごの総数
...
詳しくは、[このビデオ](https://docs.adobe.com/content/help/ja-JP/campaign-learn/campaign-standard-tutorials/designing-content/product-listings-in-transactional-email.html)を参照してください。
...
### 手順1:製品リスト{#defining-a-product-listing}を定義
...
### 手順2:製品リスト{#populating-the-product-listing}を入力
