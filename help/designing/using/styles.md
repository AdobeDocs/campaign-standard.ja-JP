...
1. 次から： **コンテキストツールバー**&#x200B;をクリックし、 **[!UICONTROL Select a column]** をクリックして、目的の列を選択します。
...
1. 必要に応じて設定を調整します。 選択した各要素には、異なる設定セットが用意されています。
   ...
   これをおこなうには、 **[!UICONTROL Settings]** ウィンドウまたは [インラインスタイル属性を追加する](#adding-inline-styling-attributes).
...
>[!NOTE]
>
>選択内容（構造コンポーネント、列コンポーネント、コンテンツコンポーネント）に応じて、結果は同じになりません。 Adobeは、 **[!UICONTROL Padding]** および **[!UICONTROL Margin]** パラメーターを列レベルで設定します。

両方に対して **[!UICONTROL Padding]** および **[!UICONTROL Margin]**&#x200B;をクリックし、上、下、右、左の各パラメーターの同期を解除するには、ロックアイコンをクリックします。 これにより、各パラメータを個別に調整できます。
...
1. 次から： **コンテキストツールバー**&#x200B;をクリックし、 **[!UICONTROL Select a column]** をクリックし、編集するものを選択します。 構造ツリーから選択することもできます。

   ![](assets/des_selecting_column.png)

   その列の編集可能なパラメーターが、 **[!UICONTROL Settings]** 右側のパネル。
...
1. コンポーネント設定で、 **[!UICONTROL Underline link]** をクリックして、リンクのラベルテキストに下線を引きます。
