...
## エクスプレッションの詳細編集について {#about-advanced-expression-editing}
...
### JavaScriptの構文 {#javascript-syntax}
...
* それぞれの条件は、**&lt;コンテキスト> &lt;比較演算子> &lt;値 2**> の形式で記述します。
   ...
   * ここで、**&lt;コンテキスト>** はコンテキストを指定できるフィールドまたは関数です。 例えば、プロファイルの電子メールアドレスの場合は&#x200B;**context.profile.@email**、プロファイルの名の文字数の場合は&#x200B;**context.profile.firstName.length （）**&#x200B;とします。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <strong>@language != English</strong>は、英語圏として定義されていないプロファイルを取得します。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> LIKE<br /> </td> 
   <td> 該当なし<br /> </td> 
   <td> 「<span class="uicontrol">次に類似</span>」は、「<span class="uicontrol">次を含む</span>」演算子と非常によく似ています。 検索対象の値にワイルドカード文字 <span class="uicontrol">%</span> を挿入することができます。<br /> </td> 
  ...
  <tr> 
   ...
   <td> <strong>@lastName NOT Smi%h</strong>。 ここで、受信者は「Smi%h」という名前に対応します（つまり、Smithなど）。 結果として返されません。<br /> </td> 
  </tr> 
  <tr> 
