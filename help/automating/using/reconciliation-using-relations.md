...
* 購入データをデータベースプロファイルおよび製品にバインドするための[紐付け](../../automating/using/reconciliation.md) アクティビティ。 ファイルデータ、プロファイルテーブル、および商品テーブルの間のリレーションを定義する必要があります。 この設定は、アクティビティの「**[!UICONTROL Relations]**」タブで実行されます。
