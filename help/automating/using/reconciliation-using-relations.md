...
* A [紐づけ](../../automating/using/reconciliation.md) 「 」アクティビティを使用して、購入データをデータベースのプロファイルおよび商品に関連付けます。 ファイルデータ、プロファイルテーブル、および商品テーブルの間のリレーションを定義する必要があります。この設定は、アクティビティの「**[!UICONTROL Relations]**」タブで実行されます。
