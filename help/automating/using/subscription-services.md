...
* [ユースケース：ファイルから特定のサービスへのプロファイルのサブスクライブ](../../automating/using/subscribing-profiles-from-file.md)
...
## 例：ファイルを読み込んだ後の特定のサービスへのプロファイルの登録 {#example--subscribing-profiles-to-a-specific-service-after-importing-a-file}
...
## 例：ファイルから複数のサブスクリプションステータスを更新する {#example--updating-multiple-subscription-statuses-from-a-file}
