...
* **[!UICONTROL Query]**:オーディエンスのリストを介してAdobe Campaign・データベースの [](../../automating/using/editing-queries.md#about-query-editor) クエリーを使用してオーディエンスが作成されたことを示します。クエリが定義したオーディエンスは、それ以降使用されるたびに再計算されます。
