...
**[配信の最適化](optimize-delivery.md)** – 送信プロセスのセキュリティを確保して最適化する

<img src="assets/do-not-localize/design.svg"  width="60px">

**[テンプレートの使用](use-templates.md)** – 新しい配信を促進して高速化する

<img src="assets/do-not-localize/custom.svg"  width="60px">

**[コンテンツをパーソナライズ](design-and-personalize.md)** – 正しい設定を適用する

<img src="assets/do-not-localize/profiles.svg"  width="60px">

**[適切なオーディエンスを定義](define-the-right-audience.md)** – 正しい設定を適用する

<img src="assets/do-not-localize/start.svg"  width="60px">

**[送信前に確認](check-before-sending.md)** – よくある間違いを避ける
...
* [プライバシーと同意の促進](../../start/using/privacy.md)
