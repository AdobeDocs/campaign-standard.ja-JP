...
| **[!UICONTROL Blocklisted address]** | すべて | ブロックリスト上のアドレスを除外します。 |
...
1. 新しいタイポロジルールを作成します。 タイポロジルールを作成する主な手順については、 [この節で説明します](../../sending/using/managing-typology-rules.md)。
...
デフォルトでは、フィルタリングはに対して実行され **[!UICONTROL Profiles]**&#x200B;ます。 例えば、モバイルアプリを対象としたルールの場合は、をに変更 **[!UICONTROL Filtering dimension]** でき **[!UICONTROL Subscriptions to an application]**&#x200B;ます。
