...
1. メッセージの送信を確認する前に、準備統計を確認してください。 送信するメッセージの数が設定に対応しない場合は、ターゲット母集団を編集し（メッセージ内のオーディエンスの選択[1&rbrace;を参照）、準備を再起動します。](../../audiences/using/selecting-an-audience-in-a-message.md)
