...
* **ターゲティングの開始時**:このフェーズでは、コントロールルールを適用できるので、エラーが発生した場合にパーソナライゼーション手順が実行されません。

* **ターゲティング後**:ターゲティング後に実行すると、コントロールルールを適用するためのターゲットのボリュームを把握できます。

   例えば、 **配達確認のサイズを確認** コントロールルールは、ターゲティングステージの後に適用されます。このルールは、配達確認受信者が多すぎる場合に、メッセージのパーソナライゼーションを準備しないようにします。

* **パーソナライゼーションの開始時**:チェックがメッセージのパーソナライゼーションの承認に関連する場合に適用されます。 メッセージのパーソナライゼーションは、分析フェーズで実行されます。

* **分析の終了時**:チェックが完了するためにメッセージのパーソナライゼーションが必要な場合。
