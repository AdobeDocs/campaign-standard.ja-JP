...
![FAQ アイコン](start/using/assets/do-not-localize/icon-faq.svg){width="60px"}
...
![コントロールパネルアイコン](start/using/assets/do-not-localize/icon-control-panel.svg){width="60px"}
...
![サポートアイコン](start/using/assets/do-not-localize/icon-support.svg){width="60px"}
